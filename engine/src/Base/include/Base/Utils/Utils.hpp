...
namespace Utils
{
    ...
    inline std::string mat4ToStr(const Mat4 &mat, int indentation = 0)
    {
        ...
        std::string result;
        char buf[1024];
        snprintf(buf, sizeof(buf), formatter.c_str(), mat[0].x, mat[1].x, mat[2].x, mat[3].x);
        result += buf;
        snprintf(buf, sizeof(buf), formatter.c_str(), mat[0].y, mat[1].y, mat[2].y, mat[3].y);
        result += buf;
        snprintf(buf, sizeof(buf), formatter.c_str(), mat[0].z, mat[1].z, mat[2].z, mat[3].z);
        result += buf;
        snprintf(buf, sizeof(buf), formatter.c_str(), mat[0].w, mat[1].w, mat[2].w, mat[3].w);
        result += buf;
